       ...
       ">
         <h1 className="h1 m-6">
           ...
           <span className="inline-block relative">brainwave <img src={curve}
            alt="curve" className="absolute left-0 top-full w-full xl:-mt-2" width={624} height={28} />
            </span>
         </h1>
       ...
       <div className="relative max-w-[23rem] mx-auto md:max-w-5xl xl:mb-22">
          <div className="relative z-1 p-0.5 rounded-2xl bg-conic-gradient">
             <div className="relative bg-n-8 rounded-[1rem]">
                ...
                md:aspect-[688/490] lg:aspect-[1034/490]
                "> 
          ...
          <div className="absolute -top-[50%] left-1/2 w-[234%] -translate-x-1/2 
